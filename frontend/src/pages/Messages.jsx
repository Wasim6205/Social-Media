  ...
  return (
    <div className='w-full min-h-[100vh] flex flex-col bg-black gap-[20px] p-[10px]'>
        ...
        <div className='w-full h-[80px] flex items-center gap-[20px] px-[20px]'>
            <MdOutlineKeyboardBackspace onClick={()=>navigate(`/`)} className='text-white lg:hidden cursor-pointer w-[25px] h-[25px]' />
        ...
        <div className='w-full h-full overflow-auto flex flex-col gap-[20px]'>
            {prevChatUsers.map((user,index)=>(
                <div key={index} className='text-white cursor-pointer w-full flex items-center gap-[10px]' onClick={()=>{
